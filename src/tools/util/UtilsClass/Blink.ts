 ...
 * 闪烁特效类
 */
class Blink extends egret.EventDispatcher {
    private _target: egret.DisplayObjectContainer;
...
*/
    public constructor(target: egret.DisplayObjectContainer, time: number, isAuto: boolean= true) {
        super();
        this._target = target;
        this._time = time;
