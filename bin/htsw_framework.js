...
var CommunicationManager = (function () {
    ...
    /** 前往指定页面 */
    CommunicationManager.prototype.goTargetPageHandle = function (pageIndex, animType) {
...
var GameLayerManager = (function (_super) {
    ...
    function GameLayerManager() {
        ...
        // 视频层
        _this.videoLayer = new eui.UILayer();
        // 主UI层 如 底部功能栏
    ...
    GameLayerManager.prototype.init = function () {
        ...
        this.videoLayer.touchThrough = true;
...
var SceneManager = (function () {
     ...
     */
    SceneManager.prototype.runScene = function (classFactory, resName, data, animType) {
        if (data === void 0) { data = null; }
        if (animType === void 0) { animType = 0; }
     ...
     * 载入资源完成后的回调函数
     */
    SceneManager.prototype.loadEnd = function () {
        if (this.animType > 0) {
            ScreenMovies.MovieStart(this.animType);
        }
        this.turnScene();
    };
    SceneManager.prototype.turnScene = function () {
     ...
     * param:  group:资源组名称
     */
    SceneManager.prototype.insertSceneInfo = function (classFactory, resName, data, animType) {
        if (data === void 0) { data = null; }
...
(function (ScreenMovies) {
    ...
    function MovieStart(_txnums) {
        ...
        var _mcW = Math.floor(w / Xnumber);
        var _mcH = Math.floor(h / Ynumber);
...
var BaseDefines = (function () {
    ...
    BaseDefines.FrameworkVersion = 18;
    return BaseDefines;
}());
...
(function (one) {
        ...
        DOMRoot.initDOMRoot = function (stage) {
            ...
            if (rootDiv == null) {
                ...
                var onResize = function () {
                    ...
                    var boundingClientWidth = playerRect.width;
                    var boundingClientHeight = playerRect.height;
                    ...
                    var stageSize = egret.sys.screenAdapter.calculateStageSize(egret.MainContext.instance.stage.scaleMode, screenWidth, screenHeight, GM.gamec.getOriginWidth(), GM.gamec.getOriginHeight());
                    ...
                    _this.scaleX = scalex * egret.sys.DisplayList.$canvasScaleFactor;
                    _this.scaleY = scaley * egret.sys.DisplayList.$canvasScaleFactor;
                    if (egret.Capabilities.renderMode == "canvas") {
                        _this.scaleX = Math.ceil(_this.scaleX);
                        _this.scaleY = Math.ceil(_this.scaleY);
                    }
    ...
    var DOMNode = (function () {
        ...
        DOMNode.prototype.updatePosition = function () {
            ...
            var _scalemode = egret.MainContext.instance.stage.scaleMode;
...
(function (one) {
    ...
    (function (FitType) {
         ...
         */
        FitType.SCALEDOWN = "scale-down";
    })(FitType = one.FitType || (one.FitType = {}));
    var WebVideo = (function (_super) {
        ...
        function WebVideo() {
            ...
            _this._fittype = one.FitType.CONTAIN;
            document.addEventListener('WeixinJSBridgeReady', _this.play.bind(_this), false);
            _this.video = document.createElement("video");
            var cur = new Date();
            _this.videoId = "video_" + cur.getTime();
            _this.video.setAttribute("id", _this.videoId);
            _this.video.autoplay = true;
            _this.video.controls = true;
            _this.video.addEventListener("canplay", _this.onVideoLoaded);
            _this.video.addEventListener("ended", function () { return _this.onVideoEnded(); });
            _this.video.addEventListener("error", function () { return _this.onVideoError(); });
        ...
        WebVideo.prototype.addToStage = function () {
            _super.prototype.addToStage.call(this);
            if (!this._fullscreen) {
                var _cssText = this.video.style.cssText + "object-fit: " + this._fittype + ";";
        ...
        WebVideo.prototype.play = function () {
            ...
            var _video = document.getElementById(this.videoId);
            if (_video)
                _video.play();
        };
        /**
        ...
        WebVideo.prototype.contentFullScreen = function () {
            var _cssText = "position: absolute; border: 0px; left: 0px; top: 0px; object-fit: " + this._fittype + ";";
            var _player = document.getElementsByClassName("egret-player")[0];
        ...
        Object.defineProperty(WebVideo.prototype, "duration", {
            /**
             * 获取视频的长度
             */
            get: function () {
        ...
        Object.defineProperty(WebVideo.prototype, "controls", {
            get: function () {
        ...
        Object.defineProperty(WebVideo.prototype, "autoPlay", {
            get: function () {
        ...
        Object.defineProperty(WebVideo.prototype, "fittype", {
            get: function () {
