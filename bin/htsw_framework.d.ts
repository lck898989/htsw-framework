...
declare class CommunicationManager {
    ...
    /** 前往指定页面 */
    goTargetPageHandle(pageIndex: number, animType?: number): void;
    /** 发送消息 */
...
declare class SceneManager {
     ...
     */
    runScene(classFactory: any, resName: string, data?: Object, animType?: number): void;
    /**
     * 载入资源完成后的回调函数
     */
    private loadEnd();
     ...
     * param:  group:资源组名称
     */
    private insertSceneInfo(classFactory, resName, data, animType);
    /**
     * 加载数组中的场景
     */
    private addNext();
...
//5.随机一种
 */
declare namespace ScreenMovies {
